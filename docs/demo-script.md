...
2. Click **Run Demo**, then **Run Bank-Mismatch Demo** for the honest offline stopping point, or open **Connect OpenAI** and use **Connect & Run Live** for the full lifecycle.
